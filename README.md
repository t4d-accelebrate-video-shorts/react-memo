...
[![YouTube Video](https://img.youtube.com/vi/DLenbxLKT6k/0.jpg)](https://www.youtube.com/watch?v=DLenbxLKT6k)
...
The provided files are the start and finish files for the video. If you desire to code along with the instructor, [Eric Greene](http://www.t4d.io), clone this repository, open the `start` folder in your code editor and get started with the [YouTube Video](https://www.youtube.com/watch?v=DLenbxLKT6k). If you prefer to review only the completed files then browse the `finish` folder. 
...
**Step 6.** Start watching the [YouTube Video](https://www.youtube.com/watch?v=DLenbxLKT6k) and code along to learn more about how to improve React functional component performance with React's Memo function
